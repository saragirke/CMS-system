...
namespace cmsSystem.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SerivceTitle,AboutService,ImageName,AltText")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SerivceTitle,AboutService,ImageName,AltText")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
