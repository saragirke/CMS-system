...
namespace cmsSystem.Controllers
{
    public class MessageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,MessageText,Email,DateCreated")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,MessageText,Email,DateCreated")] Message message)
        {
            if (id != message.Id)
            {
                return NotFound();
